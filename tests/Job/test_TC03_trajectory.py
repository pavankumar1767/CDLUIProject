...
@allure.suite("data extraction trajectory")
@pytest.mark.usefixtures("setup")
class TestTC03:
    @allure.title("Filter well with trajectory")
    def test_filter_trajectory(self, setup, config):
        page = setup
        ...
        Object_list = ["Logs", "BHA Run", "Wellbore Geometry"]
