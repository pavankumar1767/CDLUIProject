...
@allure.suite("data extraction Target")
@pytest.mark.usefixtures("setup")
class TestTC03:
    @allure.title("Verify Filter well with Target")
    def test_filter_target(self, setup, config):
        page = setup
        ...
        Object_list = test_data["wells"]["targetObjectlist"]
        data_Object = "Target"
